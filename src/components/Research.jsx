...
import { BookOpen, Map, Mountain, Database, ExternalLink, Download, ChevronRight } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <h3 className="font-semibold text-xl mb-3 flex items-center gap-2 text-amber-300">
                <img src="https://www.esri.com/content/dam/esrisites/en-us/common/icons/product-logos/arcgis-pro.png" alt="ArcGIS Logo" className="w-8 h-8" />
                ArcGIS Pro
              </h3>
